      ...
      <div className="flex flex-col h-full">
        ...
        <div className="p-4 flex flex-col justify-between h-[220px]">
          ...
          <div className="flex gap-3">
            <Link to={`/details/${now.mal_id}`} className="w-full">
